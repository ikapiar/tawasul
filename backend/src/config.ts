...
export const POSTGRESQL_URI = process.env.POSTGRESQL_URI ?? 'postgresql://localhost/tawasul';
...
export const SYMMETRIC_ENCRYPTION_KEY_SECRET = randomBytes(32)
export const SYMMETRIC_ENCRYPTION_KEY_IV = randomBytes(16)
